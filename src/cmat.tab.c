...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PRINTMAT = 33,                  /* PRINTMAT  */
  YYSYMBOL_INT = 34,                       /* INT  */
  YYSYMBOL_FLOAT = 35,                     /* FLOAT  */
  YYSYMBOL_MATRIX = 36,                    /* MATRIX  */
  YYSYMBOL_EOL = 37,                       /* EOL  */
...
static const char *const yytname[] =
{
  ...
  "FLOAT_NUMBER", "IDENTIFIER", "PLUS", "MINUS", "TIMES", "DIVIDE",
  "TRANSPOSE", "INCREMENT", "DECREMENT", "EQUAL", "NOTEQUAL", "LESSTHAN",
  "GREATERTHAN", "LESSTHANEQUAL", "GREATERTHANEQUAL", "ASSIGN", "OPENPAR",
  "CLOSEPAR", "OPENBRACK", "CLOSEBRACK", "COMMA", "SEMICOLON", "QUOTE",
  "IF", "ELSE", "WHILE", "FOR", "PRINTF", "PRINT", "PRINTMAT", "INT",
  "FLOAT", "MATRIX", "EOL", "$accept", "line", "instruction", YY_NULLPTR
};
